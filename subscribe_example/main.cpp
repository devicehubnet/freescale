...
#define AN_SENSOR_NAME  "temperature"
#define AN_ACTUATOR_NAME "light"
#define DEVICE_UUID     "3b99279d-2352-40c0-9db9-2d661fb4c566"
#define ID              "aab"                          

char* pubTopic = "/a/"API_KEY"/p/"PROJECT_ID"/d/"DEVICE_UUID"/sensor/"AN_SENSOR_NAME"/data";
char* subTopic = "/a/"API_KEY"/p/"PROJECT_ID"/d/"DEVICE_UUID"/actuator/"AN_ACTUATOR_NAME"/state";
char id[30] = ID;                 

typedef void (*function_actuator_callback)(MQTT::MessageData&);
...
int subscribe(MQTT::Client<MQTTEthernet, Countdown, MQTT_MAX_PACKET_SIZE>* client){

    return client->subscribe(subTopic,MQTT::QOS0, messageArrived);
